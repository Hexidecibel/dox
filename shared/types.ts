...
export interface SupplierRequirementRow {
  ...
  updated_by: string | null;
  /**
   * Where the row came from (0102, extended by 0112). NULL = the initial bulk
  ...
  /** 0112: the supplier-list import that last derived or re-supported this row. */
  derivation_run_id?: string | null;
  /** 0112: JSON list of `DerivationBasis` — why the list implies it. */
  derivation_basis?: string | null;
  /** 0112: 'not_on_verified_list' when a later import stopped implying a derived row. */
...
// ---------------------------------------------------------------------------
// Getting documents out of search (migration 0114)
// ---------------------------------------------------------------------------
...
// and the verified supplier list import (migration 0112).
// ═══════════════════════════════════════════════════════════════════════════
