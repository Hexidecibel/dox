-- Migration 0114: document export links -- handing a search result to someone
...
-- Plain-ASCII header on purpose (the 0110 D1 import finding). MAY NEED
-- RENUMBERING if a parallel 0114 lands first.
