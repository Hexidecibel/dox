-- Migration 0112: requirements DERIVED from a tenant's verified supplier list.
--
-- (Written as 0111; renumbered to 0112 on merge, after
-- 0111_renewal_alert_lead_time. Nothing here depends on the number.)
--
-- WHY THIS EXISTS
-- ---------------
