...
import m0107b from '../../migrations/0107_intake_duplicates.sql?raw';
...
export async function cleanTables(db: D1Database): Promise<void> {
  const tables = [
    ...
    'alert_links',
    // 0107 intake duplicates: FKs documents, processing_queue, request_uploads,
